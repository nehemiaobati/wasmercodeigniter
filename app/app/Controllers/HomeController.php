...
class HomeController extends BaseController
{
    ...
    public function landing(): string
    {
        $data = [
            ...
            'metaDescription' => 'Access powerful Generative AI tools for content, image, and video creation, plus real-time Bitcoin & Litecoin wallet data insights. A pay-as-you-go solution.',
