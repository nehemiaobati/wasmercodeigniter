        ...
        <div class="col-lg-9">
            <div class="card legal-content-card">
                <div class="card-body p-5">
                    ...
                    <p><strong>Warning:</strong> Unauthorized access to our systems, interference with data, or interception of data is a criminal offense under the <strong>Computer Misuse and Cybercrimes Act, 2018</strong> of Kenya. We will report any such activities to the relevant authorities and cooperate in the prosecution of offenders.</p>
